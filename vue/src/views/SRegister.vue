<template>
    <div class="wrapper">
        <div
            ...
            <el-form :model="student" :rules="rules" ref="studentFrom">
                <el-form-item prop="username">
                    <el-input placeholder="请输入账号" size="medium" prefix-icon="el-icon-user"
                        v-model="student.username"></el-input>
                </el-form-item>
                ...
                <el-form-item prop="confirmPassword">
                    <el-input placeholder="请确认密码" size="medium" prefix-icon="el-icon-lock" show-password
                        v-model="student.confirmPassword"></el-input>
                </el-form-item>
                <el-form-item style="margin: 5px 0; text-align: right">
                    ...
                    <el-button type="warning" size="small" autocomplete="off"
                        @click="$router.push('/Slogin')">返回登录</el-button>
                </el-form-item>
            </el-form>
        </div>
    </div>
        ...
        login() {
            this.$refs['studentFrom'].validate((valid) => {
                if (valid) {  // 表单校验合法
                    ...
                    this.request.post("/student/sregister", this.student).then(res => {
                        if (res.code === '200') {
